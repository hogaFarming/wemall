...
var DuihuanWindow = (function (_super) {
    __extends(DuihuanWindow, _super);
    function DuihuanWindow() {
        var _this = _super.call(this) || this;
        _this.init();
        return _this;
    }
    DuihuanWindow.prototype.init = function () {
        this.width = 573;
        this.height = 382;
        ...
        this.confirmBtn = new ButtonFactory().createButton(ButtonModels.DuihuanConfirmBtn);
    ...
    DuihuanWindow.prototype.handleConfirm = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, platform.exchangeCoin(amount, 1)];
                    case 2:
                        res = _a.sent();
                        new Dialog("兑换成功", function () {
                            app.modalManager.duihuanModal.close();
                        });
    ...
    DuihuanWindow.prototype.onInputChange = function (e) {
        var tx = e.target;
        var str = tx.text;
        if (!str) {
            this.txtResult.text = "";
        ...
        var amount = +str;
        this.txtResult.text = "兑换成" + utils.coinToFufen(amount) + "积分";
    };
    DuihuanWindow.prototype.checkInput = function () {
    ...
    DuihuanWindow.prototype.onOpen = function () {
        var rate = '--';
        if (app.game.exchange_rate) {
            rate = (1 / app.game.exchange_rate) + '';
        }
        this.txtTips.text = "1筹码可兑换" + rate + "积分，输入您要兑换的筹码 您的筹码：" + app.game.coin_num;
        this.txtInput.text = "";
        this.txtResult.text = "";
        return true;
    };
    DuihuanWindow.prototype.onClose = function () {
        return true;
    };
    return DuihuanWindow;
}(egret.Sprite));
__reflect(DuihuanWindow.prototype, "DuihuanWindow", ["ModalLifeCycle"]);
//# sourceMappingURL=DuihuanWindow.js.map